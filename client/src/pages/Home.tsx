    ...
    <div className="min-h-screen bg-background font-sans rtl">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/5 to-background pt-16 pb-24 md:pt-32 md:pb-32">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
          ...
          <div className="absolute bottom-[10%] -left-[10%] w-[50%] h-[50%] bg-blue-400/10 rounded-full blur-3xl" />
        </div>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground font-arabic leading-relaxed max-w-lg">
              نقدم لك أفضل حلول التأمين التي تناسب احتياجاتك وميزانيتك. حماية شاملة لك ولعائلتك وممتلكاتك بأفضل الأسعار.
            </p>
            
            <div className="flex flex-wrap gap-4 pt-4">
              <button 
                onClick={scrollToQuote}
                className="px-8 py-4 bg-primary text-white rounded-xl font-bold font-arabic shadow-lg shadow-primary/30 hover:shadow-xl hover:-translate-y-1 transition-all text-lg"
              >
                احصل على عرض سعر
              </button>
              <button 
                className="px-8 py-4 bg-white text-secondary border border-border rounded-xl font-bold font-arabic hover:bg-slate-50 transition-all text-lg"
              >
                تعرف على خدماتنا
              </button>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-10 z-20 bg-white p-6 rounded-2xl shadow-xl animate-bounce duration-1000">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground font-arabic">عملاء سعداء</p>
      ...
      <section id="offers" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <span className="text-primary font-bold font-arabic tracking-wider">عروض حصرية</span>
            <h2 className="text-4xl font-bold font-arabic text-secondary">عروضنا المميزة لهذا الشهر</h2>
            <p className="text-muted-foreground font-arabic max-w-2xl mx-auto text-lg">
              لا تفوت فرصة الاستفادة من خصوماتنا الحصرية على باقات التأمين المختلفة لفترة محدودة
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {offersLoading ? (
              ...
              <div className="col-span-full text-center py-12 bg-slate-50 rounded-2xl">
                <p className="text-muted-foreground font-arabic">لا توجد عروض حالياً، تابعنا قريباً!</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section id="products" className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl font-bold font-arabic text-secondary">خدمات التأمين الشاملة</h2>
            <p className="text-muted-foreground font-arabic max-w-2xl mx-auto text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {productsLoading ? (
              ...
              <p className="col-span-full text-center text-muted-foreground font-arabic">جاري إضافة الخدمات...</p>
            )}
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-right space-y-6">
            <h2 className="text-4xl font-bold font-arabic text-secondary">جاهز للحصول على عرض؟</h2>
            <p className="text-muted-foreground font-arabic text-lg leading-relaxed">
              فريقنا جاهز للرد على استفساراتك وتقديم أفضل عرض سعر يناسب احتياجاتك. 
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-border">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold font-arabic dir-ltr text-right">9200 00000</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2 space-y-6">
              ...
              <p className="text-slate-400 max-w-sm leading-relaxed">
                شركة رائدة في مجال خدمات التأمين في المملكة. نسعى لتقديم حلول مبتكرة تضمن حماية عملائنا وممتلكاتهم بأعلى معايير الجودة.
              </p>
            </div>
            
            <div>
              <h4 className="text-lg font-bold mb-6 text-primary">روابط سريعة</h4>
              <ul className="space-y-4 text-slate-300">
                <li><a href="#" className="hover:text-white transition-colors">عن الشركة</a></li>
                <li><a href="#products" className="hover:text-white transition-colors">خدماتنا</a></li>
            ...
            <div>
              <h4 className="text-lg font-bold mb-6 text-primary">تواصل معنا</h4>
              <ul className="space-y-4 text-slate-300">
